...
from app.api.multidomain import router as multidomain_router
...
# Multi-domain investigation API (CDR/IPDR/bank/social). Additive: the
# routes above continue to serve the original messaging pipeline.
app.include_router(multidomain_router)
